...
def make_forward(affFile: AffFile, forward: int) -> AffFile:
    '''Make the aff file "affFile" forward for "forward" time stamp.
    Only the first timing of the file and every timinggroup is kept.
    
    Warning: May cause negative time stamp items.'''
...
def module_main():
    ...
    affFile = make_forward(affFile, forward)
